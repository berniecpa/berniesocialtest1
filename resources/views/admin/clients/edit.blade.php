                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.clients.update", [$client->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('first_name') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="first_name" id="first_name" value="{{ old('first_name', $client->first_name) }}" required>
                        ...
                        <div class="form-group {{ $errors->has('last_name') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="last_name" id="last_name" value="{{ old('last_name', $client->last_name) }}">
                        ...
                        <div class="form-group {{ $errors->has('skype') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="skype" id="skype" value="{{ old('skype', $client->skype) }}">
                            @if($errors->has('skype'))
